...
class MjmlAutoConfigurationTest {
  ...
  private final ApplicationContextRunner contextRunner =
    new ApplicationContextRunner().withConfiguration(AutoConfigurations.of(MjmlAutoConfiguration.class));
  ...
  void customMjmlConfigurationTakesPrecedence() {
    contextRunner.withUserConfiguration(CustomConfigConfig.class).run(context -> {
      MjmlConfiguration config = context.getBean(MjmlConfiguration.class);
  ...
  void customMjmlServiceTakesPrecedence() {
    contextRunner.withUserConfiguration(CustomServiceConfig.class).run(context -> {
      assertThat(context).hasSingleBean(MjmlService.class);
