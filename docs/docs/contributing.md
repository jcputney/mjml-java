...
The project has 655+ tests across all modules:

| Module | Tests | Description |
|---|---|---|
| `mjml-java-core` | 577 | Unit tests + 33 golden file compatibility tests |
| `mjml-java-resolvers` | 60 | Resolver implementations |
| `mjml-java-spring` | 18 | Spring auto-configuration and services |
