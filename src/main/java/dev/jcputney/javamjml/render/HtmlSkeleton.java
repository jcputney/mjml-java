...
import dev.jcputney.javamjml.context.GlobalContext.FontDef;
import dev.jcputney.javamjml.context.GlobalContext.MediaQuery;
...
public final class HtmlSkeleton {
  ...
  public static String assemble(String bodyContent, GlobalContext ctx) {
    ...
    if (hasFluid || hasComponentStyles) {
      sb.append("  <style type=\"text/css\">\n");
      if (hasFluid) {
        sb.append("    @media only screen and (max-width:479px) {\n");
