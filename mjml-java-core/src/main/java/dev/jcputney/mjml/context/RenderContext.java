...
public class RenderContext {
  ...
  private RenderContext copy() {
    return new RenderContext(containerWidth, columnWidthSpec, index, first, last,
        insideWrapper, insideGroup, idCounter);
  }
  ...
  public RenderContext withWidth(double width) {
    return new RenderContext(width, columnWidthSpec, index, first, last,
        insideWrapper, insideGroup, idCounter);
  }
