...
/**
 * Context information passed to {@link IncludeResolver} when resolving includes. Provides metadata
 ...
 *
 * @param includingPath the path of the file that contains the mj-include, or null for the root
 *     document
