...
public class MjAccordionTitle extends BodyComponent {
  ...
  public String render() {
    ...
    String iconUnwrappedUrl =
        resolveAncestorAttr("icon-unwrapped-url", "https://i.imgur.com/w4uTygT.png");
    String iconUnwrappedAlt = resolveAncestorAttr("icon-unwrapped-alt", "-");
    String iconWrappedUrl =
        resolveAncestorAttr("icon-wrapped-url", "https://i.imgur.com/bIXv1bk.png");
