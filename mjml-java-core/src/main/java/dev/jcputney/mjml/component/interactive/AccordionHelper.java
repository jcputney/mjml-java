...
/**
 * Shared utility for accordion sub-components ({@code mj-accordion-title}, {@code
 * mj-accordion-text}) that need to resolve attributes from ancestor accordion nodes via the full
 * attribute cascade.
 */
