...
public class MjAccordionElement extends BodyComponent {
    ...
    public String render() {
        ...
        html.rawVerbatim("<input class=\"mj-accordion-checkbox\" type=\"checkbox\" style=\"display:none;\" />");
    ...
    String resolveAttr(String name, String fallback) {
        ...
        if (parent != null) {
            String parentVal = AttributeResolver.resolve(parent, name, globalContext, MjAccordion.DEFAULTS);
