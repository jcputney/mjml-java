...
public sealed interface CssSelector {
   ...
   */
  record ComplexSelector(CssSelector left, Combinator combinator, CssSelector right) implements CssSelector {
   ...
   */
  record AttributeSelector(String attribute, String operator, String value) implements SimpleSelector {
