...
public final class DefaultFontRegistry {
    ...
    static {
        DEFAULT_FONTS.put("Open Sans", "https://fonts.googleapis.com/css?family=Open+Sans:300,400,500,700");
        DEFAULT_FONTS.put("Droid Sans", "https://fonts.googleapis.com/css?family=Droid+Sans:300,400,500,700");
    ...
    public static void registerUsedFonts(String fontFamily, GlobalContext ctx, Set<String> registeredNames) {
        ...
        for (Map.Entry<String, String> override :
                ctx.styles().getFontUrlOverrides().entrySet()) {
