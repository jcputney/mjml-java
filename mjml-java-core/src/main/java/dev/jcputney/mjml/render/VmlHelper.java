...
public final class VmlHelper {
    ...
    public static String buildSectionVmlRect(
            String widthStyle, String bgUrl, String bgColor, String bgPosition, String bgSize, String bgRepeat) {
    ...
    private static void appendVmlFill(
            StringBuilder sb, String origin, String position, String bgUrl, String bgColor, String vmlType) {
        ...
        if (bgColor != null && !bgColor.isEmpty()) {
            sb.append(" color=\"")
                    .append(HtmlEscaper.escapeAttributeValue(bgColor))
                    .append("\"");
        }
