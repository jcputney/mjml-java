 ...
 * An attacker who controls MJML input could use {@code <mj-include>} to probe internal
 * network resources. HTTP-based resolvers should validate and restrict allowed hosts/URLs.</p>
 */
@FunctionalInterface
