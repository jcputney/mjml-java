...
class BoundaryTest {
    ...
    void inputExactlyAtMaxSizeIsAccepted() {
        ...
        MjmlConfiguration config =
                MjmlConfiguration.builder().maxInputSize(limit).build();
    ...
    void inputOneCharOverMaxSizeIsRejected() {
        ...
        assertTrue(ex.getMessage().contains("exceeds maximum"), "Error message should mention exceeding maximum");
    }
    ...
    void nestingDepthAtLimitIsRejected() {
        ...
        MjmlConfiguration config =
                MjmlConfiguration.builder().maxNestingDepth(3).build();
    ...
    void normalNestingDepthIsAccepted() {
        ...
        MjmlConfiguration config =
                MjmlConfiguration.builder().maxNestingDepth(100).build();
