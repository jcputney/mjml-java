...
class AttributeResolverTest {
    ...
    void allFiveLevelsPopulatedInlineWins() {
        ...
        assertEquals("#inline", AttributeResolver.resolve(node, "font-size", globalContext, componentDefaults));
    }
    ...
    void withoutInlineClassWins() {
        ...
        assertEquals("#class", AttributeResolver.resolve(node, "font-size", globalContext, componentDefaults));
    }
    ...
    void withoutInlineOrClassTagWins() {
        ...
        assertEquals("#tag", AttributeResolver.resolve(node, "font-size", globalContext, componentDefaults));
    }
}
