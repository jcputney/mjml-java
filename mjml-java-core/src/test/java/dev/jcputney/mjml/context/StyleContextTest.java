...
class StyleContextTest {
  ...
  void fontsUnmodifiable() {
    StyleContext ctx = new StyleContext();
    assertThrows(UnsupportedOperationException.class, () -> ctx.getFonts().add(new StyleContext.FontDef("x", "y")));
  }
  ...
  void inlineStylesUnmodifiable() {
    ...
    assertThrows(
      UnsupportedOperationException.class, () -> ctx.getInlineStyles().add("x"));
  }
}
