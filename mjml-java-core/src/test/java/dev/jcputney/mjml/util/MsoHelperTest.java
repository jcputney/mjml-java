...
class MsoHelperTest {
  ...
  void msoConditionalTableClosing() {
    assertEquals("<!--[if mso | IE]></td></tr></table><![endif]-->", MsoHelper.msoConditionalTableClosing());
  }

  @Test
  void msoTdStyleConstant() {
    assertEquals("line-height:0px;font-size:0px;mso-line-height-rule:exactly;", MsoHelper.MSO_TD_STYLE);
  }

  @Test
  void msoTdStyleHeroConstant() {
    assertEquals("line-height:0;font-size:0;mso-line-height-rule:exactly;", MsoHelper.MSO_TD_STYLE_HERO);
  }
