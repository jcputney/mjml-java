...
class ParserEdgeCaseTest {
  ...
  void handlesXmlDeclaration() {
    ...
    assertNotNull(html);
    assertTrue(html.contains("XML declaration test"), "Content should render correctly with XML declaration");
  }
  ...
  void throwsOnWhitespaceOnlyInput() {
    assertThrows(
      MjmlException.class, () -> MjmlParser.parse("   \n\t\r  "), "Whitespace-only input should be rejected");
  }
  ...
  void throwsOnSingleSpaceInput() {
    assertThrows(MjmlException.class, () -> MjmlParser.parse(" "), "Single space should be rejected");
  }
  ...
  void handlesUnicodeContent() {
    ...
    assertTrue(html.contains("\u043F\u0440\u0438\u0432\u0435\u0442"), "Russian characters should be preserved");
  }
  ...
  void handlesCommentsInBody() {
    ...
    String html = assertDoesNotThrow(() -> MjmlRenderer.render(mjml).html());
    assertNotNull(html);
    assertTrue(html.contains("After comments"), "Content should render correctly when comments are present");
  }
}
