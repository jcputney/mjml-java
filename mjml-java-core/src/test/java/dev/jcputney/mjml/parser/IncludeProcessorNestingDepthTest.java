...
class IncludeProcessorNestingDepthTest {
  ...
  void includeRespectsMaxNestingDepth() {
    ...
    MjmlDocument doc = MjmlParser.parse("<mjml><mj-body><mj-include path=\"fragment.mjml\" /></mj-body></mjml>");
  ...
  void fullMjmlIncludeRespectsMaxNestingDepth() {
    ...
    MjmlDocument doc = MjmlParser.parse("<mjml><mj-body><mj-include path=\"full.mjml\" /></mj-body></mjml>");
